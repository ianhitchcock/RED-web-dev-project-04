 ...
 * @author    Ian <ianhitchcock@outlook.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        https://github.com/htichcock/RED-web-dev-project-04
 * Description:       A nifty Business Hours widget built custom for the Inhabitent Site
 * Version:           1.0.0
 * Author:            Ian
 * Author URI:        https://github.com/htichcock
 * License:           GPL-2.0+
...
// : change 'Widget_Name' to the name of your plugin
class Tent_Biz_Hours extends WP_Widget {

    /**
     * - Rename "widget-name" to the name your your widget
     *
